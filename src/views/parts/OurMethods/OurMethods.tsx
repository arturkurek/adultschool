...
„Nieważne, czy to metoda nowoczesna, czy tradycyjna – ważne, aby była skuteczna!”.</li>
                    ...
                    <li>Podstawą naszych zajęć jest sprawdzony, polecany, ogólnodostępny kurs. Wzbogaciliśmy go jednak o nasze autorskie gry i zabawy językowe, które znacząco podnoszą efektywność nauki. Wierzymy, że jeśli nauka jest przyjemna, jest jednocześnie efektywna, a wiedza zdobyta w przyjaznej atmosferze pozostaje z nami na dłużej.</li>
                    <li>Intensywnie ćwiczymy słuchanie i mówienie oraz inne umiejętności językowe, które są podstawą swobodnej komunikacji.</li>
                    <li>Wszystko sprowadza się do tego, aby nasi kursanci mogli swobodnie komunikować się w języku angielskim, niezależnie od sytuacji w jakiej się znajdą.</li>
                </ul>
            </div>
        </section>
    )
